...
const ShowcaseTechStack = () => (
  <section className="tech-section">
    <style>{`
      ...
      .tech-box::before { content: ''; position: absolute; top: -50%; left: -50%; width: 200%; height: 200%; background: radial-gradient(circle at center, rgba(37, 99, 235,0.4) 0%, transparent 40%); pointer-events: none; z-index: 0; }
      ...
      .tech-pill:hover { background: #2563eb; color: white; border-color: #2563eb; transform: translateY(-5px); box-shadow: 0 10px 20px rgba(37, 99, 235,0.5); }
