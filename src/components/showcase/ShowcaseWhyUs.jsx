...
const ShowcaseWhyUs = () => (
  <section className="wyu-section">
    <style>{`
      ...
      .wyu-badge { display: inline-block; background: rgba(37, 99, 235, 0.1); border: 1px solid rgba(37, 99, 235, 0.2); color: #2563eb; padding: 9px 24px; border-radius: 40px; font-size: 13px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 20px; }
      ...
      .wyu-card:hover { transform: translateY(-5px); border-color: rgba(37, 99, 235, 0.3); background: rgba(255, 255, 255, 0.04); }
      .wyu-year { color: #2563eb; font-size: 1.2rem; font-weight: 800; margin-bottom: 10px; }
      ...
      .wyu-dot { position: absolute; left: 50%; top: 50%; transform: translate(-50%,-50%); width: 20px; height: 20px; background: #2563eb; border: 4px solid #2563eb; border-radius: 50%; box-shadow: 0 0 20px rgba(37, 99, 235, 0.5); z-index: 2; }
      .wyu-spacer { width: 45%; }
