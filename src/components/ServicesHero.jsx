  ...
  return (
    <>
      ...
      <style>{`
        ...
        .sh-arc:nth-child(1) { width:110px; height:110px; border:16px solid #083878; bottom:-28px; right:-28px; animation:shFloat 4s ease-in-out infinite; }
        .sh-arc:nth-child(2) { width:170px; height:170px; border:16px solid rgba(8,56,120,0.35); bottom:-55px; right:-55px; animation:shFloat 5.5s 0.8s ease-in-out infinite; }
        ...
        .sh-breadcrumb:hover { background:rgba(255,255,255,0.16); border-color:rgba(255,255,255,0.45); transform:translateY(-2px); box-shadow:0 8px 24px rgba(0,0,0,0.2); }
