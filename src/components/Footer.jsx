      ...
      <style>{`
        * {
        ...
        .footer-logo-img {
          ...
          height: 150px;
          display: block;
          background: radial-gradient(ellipse at center, rgba(255, 255, 255, 0.95) 35%, rgba(255, 255, 255, 0) 75%);
          object-fit: contain;
          padding: 10px;
        }
          ...
          <div className="footer-top">
            ...
            <div className="footer-brand">
              ...
              <p className="footer-desc">
                RiDeal Digital Seva delivers innovative IT and digital solutions to help businesses scale faster.
              </p>
