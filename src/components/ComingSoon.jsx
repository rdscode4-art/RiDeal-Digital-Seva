...
const ComingSoon = () => (
  <>
    ...
    <style>{`
      ...
      @keyframes csPulse  { 0%,100% { box-shadow:0 0 0 0 rgba(8,56,120,0.3); } 50% { box-shadow:0 0 0 16px rgba(8,56,120,0); } }
      ...
      .cs-soon-orb-1 {
        ...
        background: radial-gradient(circle, rgba(8,56,120,0.07) 0%, transparent 65%);
        top: -120px; left: -120px;
      }
      .cs-soon-orb-2 {
        width: 320px; height: 320px;
        background: radial-gradient(circle, rgba(8,56,120,0.06) 0%, transparent 65%);
      ...
      .cs-soon-icon-wrap {
        ...
        font-size: 42px;
        color: #fff;
        box-shadow: 0 16px 48px rgba(8,56,120,0.3);
      ...
      .cs-soon-ring::before {
        ...
        border-radius: 50%;
        border: 2px dashed rgba(8,56,120,0.2);
      ...
      .cs-soon-ring::after {
        ...
        border-radius: 50%;
        border: 1.5px dashed rgba(8,56,120,0.1);
      ...
      .cs-soon-btn {
        ...
        box-shadow: 0 8px 28px rgba(8,56,120,0.3);
        letter-spacing: 0.2px;
        margin-top: 8px;
      }
      .cs-soon-btn:hover { transform:translateY(-3px); box-shadow:0 16px 40px rgba(8,56,120,0.42); }
